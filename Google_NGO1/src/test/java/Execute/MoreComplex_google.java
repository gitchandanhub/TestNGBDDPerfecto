...
public class MoreComplex_google 
{
	...
	public void g() throws InterruptedException, IOException
	{
	  ...
	  // foptions.setCapability("marionette", false);
	   // driver = new FirefoxDriver(foptions);
	    ...
	    src = new File("D:\\Software\\Database_2020\\db shop database\\All India Doctor may 2020\\google\\foreignDoctordatabase4.xlsx");
		wb = new XSSFWorkbook(); 
	...
	{
		for(int i =73; i<22009; i++)
		{
			City = Readwriteexcel.readexcel("D:\\Software\\Database_2020\\db shop database\\All India Doctor may 2020\\google\\foreigndocurl.xlsx", 0, i, 0);
			String url = Readwriteexcel.readexcel("D:\\Software\\Database_2020\\db shop database\\All India Doctor may 2020\\google\\foreigndocurl.xlsx", 0, i, 1);
			category = Readwriteexcel.readexcel("D:\\Software\\Database_2020\\db shop database\\All India Doctor may 2020\\google\\foreigndocurl.xlsx", 0, i, 2);
