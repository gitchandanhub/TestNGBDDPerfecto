...
public class google1 
{
	...
	public void launch() throws InterruptedException, IOException
	{
	  ...
	  // foptions.setCapability("marionette", false);
	   // driver = new FirefoxDriver(foptions);
	    ...
	    src = new File("D:\\Software\\Database_2020\\db shop database\\All India Doctor may 2020\\google\\foreigndocurl2.xlsx");
		wb = new XSSFWorkbook(); 
	...
	public void a() throws IOException, InterruptedException
	{
		for(int i =2; i<4; i++)
		{
			String city = Readwriteexcel.readexcel("D:\\Software\\Database_2020\\db shop database\\All India Doctor may 2020\\google\\city_input_main.xlsx", 1, i, 0);
			for(int j =1; j<54; j++)
			{
		    String category = Readwriteexcel.readexcel("D:\\Software\\Database_2020\\db shop database\\All India Doctor may 2020\\google\\category_input_new.xlsx", 0, j, 0);
